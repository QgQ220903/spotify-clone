...
const DisplayPlaylist = () => {
  ...
  return (
   <>
   {playlist && ( <div className="min-h-screen w-full bg-gradient-to-b from-[#333] via-[#111] to-black text-white">
      {/* Playlist Header */}
      <h1>{id}</h1>
      <div className="flex items-end gap-6 p-6">
        ...
        <div className="flex flex-col justify-end">
          ...
          <p className="text-white/70 mt-4 text-sm">{playlist.songs.length +' bài hát'}</p>
        </div>
      </div>
